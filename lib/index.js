    ...
    _createClass(Selector, null, [{
        ...
        value: function find(jObj, selector) {
            ...
            jObj.forEach(function (element) {
                _this._querySelectorAll(element, selector).forEach(function (queryElement) {
                    elements.push(queryElement);
                });
            });
        ...
        value: function _querySelectorAll(element, selector) {
            ...
            if (scopeClass) {
                _Style2.default._addClass(element, scopeClass);
            }
            ...
            if (scopeClass) {
                _Style2.default._removeClass(element, scopeClass);
            }
            return elements;
        }
    }, {
...
var Style = function () {
    ...
    _createClass(Style, null, [{
        ...
        key: '_addClass',
        value: function _addClass(element) {
        ...
        key: '_removeClass',
        value: function _removeClass(element) {
            if (typeof element.classList !== 'undefined') {
